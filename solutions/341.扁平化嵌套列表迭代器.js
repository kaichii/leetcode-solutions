...
NestedIterator.prototype.hasNext = function () {
  ...
  while (++this.cursor < this.size) {
    if (this.nestedList[this.cursor].isInteger()) {
      this.iterator = null;
      return true;
    }

    this.iterator = new NestedIterator(this.nestedList[this.cursor].getList());
...
NestedIterator.prototype.next = function () {
  if (this.iterator == null) return this.nestedList[this.cursor].getInteger();
